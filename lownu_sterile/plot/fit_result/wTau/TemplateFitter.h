...
class TemplateFitter {
  ...
  public:
    ...
    void setPara(char var[20], double oscpar[4], int para, int nuCut, double seed[4], double fitPara_m[29][7], double fitPara_e[29][7]);
    bool doFit(double &Uee2, double &Umm2, double &Utt2, double &dm2);
    //void Draw(double bf[3]);
    void getTarget(double oscpar[4]);
    double bfChi2(double bf[4]);
  ...
  private:
    ...
    double getAvgPmue(double energy, double Uee2, double Umm2, double Utt2, double dm2, double ft[7]);
    double getAvgPee(double energy, double Uee2, double Umm2, double Utt2, double dm2, double ft[7]);
    double getAvgPmm(double energy, double Uee2, double Umm2, double Utt2, double dm2, double ft[7]);
