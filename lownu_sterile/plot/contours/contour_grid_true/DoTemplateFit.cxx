...
int main(int argc, char const *argv[])
{
  ...
  TFile *CC_f  = new TFile(Form("CC_output_56bins.root"),"READ");
  TFile *nue_f = new TFile(Form("nue_output_8bins.root"),"READ");
  ...
  TFile *f_sig = new TFile(Form("total_sigmtr%d_5sig_120.root",nuCut), "READ");
