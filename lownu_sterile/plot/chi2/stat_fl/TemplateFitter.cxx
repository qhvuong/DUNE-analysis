...
*/
  ...
  h2->Draw("colz");
  g2->Draw("same C*");
  cchi2->SaveAs(Form("%s_chi2Surface_stat_fl_%d%d.png",name,para,cutNu)); 
  ...
  h2z->Draw("colz");
  g2->Draw("same C*");
  cchi2_z->SaveAs(Form("%s_chi2Surface_stat_fl_%d%d_zoom.png",name,para,cutNu)); 
  ...
  h2d->Draw("colz");
  g2->Draw("same C*");
  cdiff->SaveAs(Form("%s_chi2Diff_stat_fl_%d%d.png",name,para,cutNu)); 
  ...
  h2dz->Draw("colz");
  g2->Draw("same C*");
  cdiff_z->SaveAs(Form("%s_chi2Diff_stat_fl_%d%d_zoom.png",name,para,cutNu)); 

  TFile *out = new TFile(Form("%s_chi2_stat_fl_%d%d.root",name,para,cutNu),"RECREATE");
  h0->Write();
  h1->Write();
  h2->Write();
  h0z->Write();
