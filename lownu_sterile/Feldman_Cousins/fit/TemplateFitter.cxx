...
void TemplateFitter::Draw( double bf[3] )
{
  double par[3];
  par[0] = bf[3];
  par[1] = bf[1];
  ...
  CCe_tgt->SetLineColor(kBlack);
  CCe_tgt->SetLineWidth(2);
  ...
  legend_e->Draw();
  ce->SaveAs(Form("fit_CCe_3sig_%d%d.png",para,cutNu));

  THStack *hm = new THStack("hm","");
  CCm_tgt->SetLineColor(kBlack);
  CCm_tgt->SetLineWidth(2);
  ...
  legend_m->Draw();
  cm->SaveAs(Form("fit_CCm_3sig_%d%d.png",para,cutNu));

  THStack *hnue = new THStack("hnue","");
  nue_tgt->SetLineColor(kBlack);
  nue_tgt->SetLineWidth(2);
  ...
  legend_nue->Draw();
  cnue->SaveAs(Form("fit_nue_3sig_%d%d.png",para,cutNu));
