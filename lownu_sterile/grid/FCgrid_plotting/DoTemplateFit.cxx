...
int main(int argc, char const *argv[])
{
  ...
  // TFile *f_fl = new TFile(Form("%s/uncertainties/flux_covmtr/flux_covmtr_wBKG%s.root",data_path,kEtheta2_cut),"READ");
  // TFile *f_xS = new TFile(Form("%s/uncertainties/xS_covmtr/xS_covmtr_wBKG%s.root",data_path,kEtheta2_cut), "READ");
  // TFile *f_det = new TFile(Form("%s/uncertainties/det_covmtr/det_covmtr_wBKG%s.root",data_path,kEtheta2_cut),"READ");

  // TFile *f_xS  = new TFile(Form("xS_covmtr_wBKG_2MeV.root"), "READ");
  // TFile *f_fl  = new TFile(Form("flux_covmtr_wBKG_2MeV.root"),"READ");
  // TFile *f_det = new TFile(Form("det_covmtr_wBKG_2MeV.root"),"READ");
  ...
  double ratio = tf.getTarget( tgtPar, nucut, originalTgt );
