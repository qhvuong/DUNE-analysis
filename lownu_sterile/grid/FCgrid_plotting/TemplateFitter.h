...
// Low-ν (GeV) cuts
const double kNuCuts[] = {50., 1., 0.5, 0.3, 0.1, 0.08};
...
class TemplateFitter {
  public:
    ...
    double getTarget(double par[4], int nucut, bool originalTgt = false);
  ...
  private:
    ...
    int kNuCut;
    TH1D* hNull        = new TH1D("hNull","",nbins,0,nbins);
    TH1D* hRatioToNull = new TH1D("hRatioToNull","",nbins,0,nbins);
