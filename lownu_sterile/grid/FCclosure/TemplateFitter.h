...
static const int nbins = nbinsCC + nbinsCC + nbins_nue;
...
class TemplateFitter {
  public:
    TemplateFitter(TemplateGroup_CC (&ccTemplates)[nbins_Ev], TemplateGroup_nue (&nueTemplates)[nbins_Ev]);
    ~TemplateFitter() {}
  ...
  private:
    ...
    TMatrixD invmx = TMatrixD(nbins, nbins);
    ...
    TMatrixD myTarget = TMatrixD(nbins, 1);
};
