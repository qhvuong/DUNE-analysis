...
TemplateFitter::TemplateFitter(TemplateGroup_CC (&ccTemplates)[nbins_Ev], TemplateGroup_nue (&nueTemplates)[nbins_Ev]) {
                                               ...
                                               bool plotBestfit) const
{
  ...
  if(plotBestfit){
    ...
    //tgt->SetLineColor(kGreen);
    tgt->SetLineWidth(2.);
    tgt->SetLineStyle(9);
    //FCtgt->SetLineColor(kBlack);
