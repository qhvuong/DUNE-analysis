...
int main(int argc, char const *argv[])
{
  ...
  TFile *CC_f = new TFile("CCTemplates_NoBKG_2MeV.root","READ");
  TFile *nue_f = new TFile("nueTemplates_NoBKG_2MeV.root","READ");
  ...
  TH2D* CC_he_inverseEtheta2_cc = (TH2D*)CC_f->Get(Form("eElepRecoVsEv_inverseEtheta2_CC_nucut%d",nucut));
  TH2D* CC_he_inverseEtheta2_nc = (TH2D*)CC_f->Get(Form("eElepRecoVsEv_inverseEtheta2_NC_nucut%d",nucut));
