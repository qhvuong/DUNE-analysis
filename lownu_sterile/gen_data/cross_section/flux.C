void flux()
{
  TH1D *h  = new TH1D("h","",50,0,16);
  TH1D *h1 = new TH1D("h1","",50,0,16);
  TH1D *h2 = new TH1D("h2","",50,0,16);

  TH1D *he  = new TH1D("he","",50,0,16);
  TH1D *he1 = new TH1D("he1","",50,0,16);
  TH1D *he2 = new TH1D("he2","",50,0,16);
  ...
  for(int ii=0; ii<tree->GetEntries(); ii++)
  {
    ...
    if( pdg==12 && abs(vtxx)<3 && vtxy>-1.516 && vtxy<0.516 ) he1->Fill(E);
  }
  ...
  for(int ii=0; ii<tree->GetEntries(); ii++)
  {
    ...
    if( pdg==12 && abs(vtxx)<3 && vtxy>-1.516 && vtxy<0.516 ) he2->Fill(E);
  }
  ...
  c->Clear();
  he->SetTitle("Corrected nue flux");
  he->GetXaxis()->SetTitle("Ev (GeV)");
  he->Draw();
