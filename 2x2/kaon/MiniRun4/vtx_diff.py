...
for d in range(Nfiles):
  ...
  for vtx in Ints['vertex_id']:
    ...
    print(trajs[(trajs['vertex_id']==vtx) & (trajs['pdg_id']==pid)])
    for pid in pids:
      if pid not in trajs[trajs['vertex_id']==vtx]['pdg_id']: continue
      print("with pion", trajs[(trajs['vertex_id']==vtx) & (trajs['pdg_id']==pid)])
      list_dict[pid]['dt_trajs'].extend(trajs[(trajs['vertex_id']==vtx) & (trajs['pdg_id']==pid)]['t_end'] - trajs[(trajs['vertex_id']==vtx) & (trajs['pdg_id']==pid)]['t_start'])
      #list_dict[pid]['dE'].extend(tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['dE'])
      #list_dict[pid]['dEdx'].extend(tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['dEdx'])
      #list_dict[pid]['dx'].extend(tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['dx'])
      #list_dict[pid]['t0'].extend(tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['t0'])
      #list_dict[pid]['dt'].extend(tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['t0_end'] - tracks[(tracks['vertex_id']==vtx) & (tracks['pdg_id']==pid)]['t0_start'])
